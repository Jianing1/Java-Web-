    ...
    (function (t, e) {
        ...
        i.event = {
            ...
            gestures: [], current: null, previous: null, stopped: !1, startDetect: function (t, e) {
                ...
                var o = t.timeStamp - e.timeStamp, s = t.center.pageX - e.center.pageX,
                    a = t.center.pageY - e.center.pageY, c = i.utils.getVelocity(o, s, a);
...
(function (e, t) {
    ...
    var d = function (n) {
        ...
        if (!a.hasClass("preview4")) {
            ...
            TweenLite.to(h, .5, {
                autoAlpha: 0, onComplete: function () {
                    TweenLite.to(c, .5, {autoAlpha: 1, delay: .2});
                    TweenLite.to(h, .5, {autoAlpha: 1, delay: .2})
                }
            })
        } else {
            p.css({backgroundImage: "url(" + u + ")"});
            d.css({backgroundImage: "url(" + o + ")"});
            TweenLite.fromTo(p, .8, {force3D: true, x: 0}, {
                x: -c.width(),
                ease: Power3.easeOut,
                delay: 1,
                onComplete: function () {
            ...
            TweenLite.fromTo(d, .8, {force3D: true, x: 0}, {
                x: c.width(),
                ease: Power3.easeOut,
                delay: 1,
                onComplete: function () {
        ...
        if (f.hasClass("preview4") && !f.hasClass("hashoveralready")) {
            ...
            f.hover(function () {
                ...
                TweenLite.fromTo(t, .4, {x: t.width()}, {x: 0, delay: .3, ease: Power3.easeOut, overwrite: "all"});
                TweenLite.to(n, .2, {autoAlpha: 1, overwrite: "all"})
            }, function () {
                var t = e(this).find(".tp-arr-iwrapper");
                var n = e(this).find(".tp-arr-allwrapper");
                TweenLite.to(t, .4, {x: t.width(), ease: Power3.easeOut, delay: .2, overwrite: "all"});
                TweenLite.to(n, .2, {delay: .6, autoAlpha: 0, overwrite: "all"})
            });
            l.hover(function () {
                var t = e(this).find(".tp-arr-iwrapper");
                var n = e(this).find(".tp-arr-allwrapper");
                TweenLite.fromTo(t, .4, {x: 0 - t.width()}, {x: 0, delay: .3, ease: Power3.easeOut, overwrite: "all"});
                TweenLite.to(n, .2, {autoAlpha: 1, overwrite: "all"})
            }, function () {
                var t = e(this).find(".tp-arr-iwrapper");
                var n = e(this).find(".tp-arr-allwrapper");
                TweenLite.to(t, .4, {x: 0 - t.width(), ease: Power3.easeOut, delay: .2, overwrite: "all"});
                TweenLite.to(n, .2, {delay: .6, autoAlpha: 0, overwrite: "all"})
            })
        }
    };
    ...
    var C = function (n, r) {
        ...
        n.find(">li").each(function () {
            var t = e(this);
            if (t.index != r.act && t.index != r.next) TweenLite.set(t, {zIndex: 16})
        });
    ...
    var k = function (n, r, i, s, u, a) {
        ...
        if (f == 3) {
            ...
            a.find(".slotslide").each(function () {
                var t = e(this);
                TweenLite.fromTo(t, T / 1e3, {top: 0 - r.sloth, rotation: r.rotate, transformPerspective: 600}, {
                    top: 0,
                    rotation: 0,
                    ease: Power2.easeOut,
                    onComplete: function () {
        ...
        if (f == 4 || f == 5) {
            ...
            a.find(".slotslide").each(function (t) {
                ...
                TweenLite.fromTo(o, A * 3, {
                    ...
                    top: 0, opacity: 1, rotation: 0, ease: Power2.easeInOut, delay: l, onComplete: function () {
                        if (t == r.slots - 1) {
                            L(n, r, a, u, i, s)
                        }
                    }
        ...
        if (f == 8) {
            ...
            a.find(".slotslide").each(function (t) {
                var o = e(this).find("div");
                TweenLite.fromTo(o, T / 1e3, {left: 0, top: 0, opacity: 0, transformPerspective: 600}, {
                    left: 0 + "px",
                    top: 0 - t * r.sloth + "px",
        ...
        if (f == 9 || f == 10) {
            ...
            a.find(".slotslide").each(function (t) {
                var n = e(this);
                M++;
                TweenLite.fromTo(n, T / 1e3, {opacity: 0, transformPerspective: 600, left: 0, top: 0}, {
                    opacity: 1,
                    ease: Power2.easeInOut,
                    delay: t * 4 / 1e3
                })
        ...
        if (f == 11 || f == 26) {
            ...
            a.find(".slotslide").each(function (t) {
                var n = e(this);
                TweenLite.fromTo(n, T / 1e3, {opacity: 0}, {opacity: 1, ease: Power2.easeInOut})
            });
            setTimeout(function () {
                L(n, r, a, u, i, s)
            }, T + 15)
        ...
        if (f == 12 || f == 13 || f == 14 || f == 15) {
            ...
            if (p == 6) q = .6;
            TweenLite.fromTo(P, z, {left: H, top: j, scale: q, opacity: F, rotation: r.rotate}, {
                opacity: 1,
                rotation: 0,
                left: 0,
                top: 0,
        ...
        if (f == 19 || f == 22) {
            ...
            TweenLite.fromTo(a, T / 2e3, {transformPerspective: 600, z: 0, x: 0, rotationY: 0}, {
                rotationY: 1,
                ease: Power1.easeInOut,
                z: -40
            });
            TweenLite.fromTo(a, T / 2e3, {transformPerspective: 600, z: -40, rotationY: 1}, {
                rotationY: 0,
                z: 0,
                ease: Power1.easeInOut,
                x: 0,
            ...
            TweenLite.fromTo(u, T / 2e3, {transformPerspective: 600, z: 0, x: 0, rotationY: 0}, {
                rotationY: 1,
                x: 0,
                ease: Power1.easeInOut,
                z: -40
            });
            TweenLite.fromTo(u, T / 2e3, {transformPerspective: 600, z: -40, x: 0, rotationY: 1}, {
                rotationY: 0,
                z: 0,
                x: 0,
                ease: Power1.easeInOut,
            ...
            a.find(".slotslide").each(function (t) {
                ...
                TweenLite.to(o, .1, {opacity: 1, delay: t * 50 / 1e3 + T / 3e3})
            });
            u.find(".slotslide").each(function (t) {
                var o = e(this);
                var f = -90;
                ...
                TweenLite.to(o, .1, {opacity: 0, delay: t * 50 / 1e3 + (T / 1e3 - T / 1e4)})
            })
        }
        if (f == 20) {
            a.find(".defaultimg").css({opacity: 0});
            ...
            a.find(".slotslide").each(function (t) {
                ...
                TweenLite.to(o, .1, {opacity: 1, delay: t * 50 / 1e3 + T / 2e3})
            });
            u.find(".slotslide").each(function (t) {
                var o = e(this);
                if (x != 1) {
        ...
        if (f == 21 || f == 25) {
            ...
            a.find(".slotslide").each(function (t) {
                ...
                TweenLite.to(o, .3, {opacity: 1, delay: t * 100 / 1e3 + T * .2 / 2e3 + T / 1e4})
            });
            if (x != 1) {
                var ot = -r.width;
                var it = 90;
            ...
            u.find(".slotslide").each(function (t) {
                ...
                TweenLite.to(n, .2, {opacity: 0, delay: t * 50 / 1e3 + (T / 3e3 - T / 1e4)})
            })
        }
        if (f == 23 || f == 24) {
            a.find(".defaultimg").css({opacity: 0});
            ...
            TweenLite.fromTo(a, T / 2e3, {transformPerspective: 600, z: -90, rotationY: 1}, {
                rotationY: 0,
                z: 0,
                ease: Power1.easeInOut,
                x: 0,
            ...
            TweenLite.fromTo(u, T / 2e3, {transformPerspective: 600, z: -90, x: 0, rotationY: 1}, {
                rotationY: 0,
                z: 0,
                x: 0,
                ease: Power1.easeInOut,
    ...
    var B = function (n, r, i) {
        var s = 0;
        var o = 0;
        var u = n.find(".tp-caption"), a = r.container.find(".tp-static-layers").find(".tp-caption");
                                ...
                                try {
                                    ...
                                    var o = setInterval(function () {
                                        if (YT != t) if (typeof YT.Player != t && typeof YT.Player != "undefined") {
                                            ...
                                            } else s = new YT.Player(p, {events: {onStateChange: A}});
    ...
    var q = function (n, r) {
        ...
        n.find(".rs-slideloop").each(function () {
            ...
            if (n.data("timeline") == t) {
                ...
                xe = xe * r;
                ye = ye * r;
                n.data("timeline").append(new TweenLite.fromTo(n, speed, {x: i, y: s}, {x: xe, y: ye, ease: easing}));
                n.data("timeline").append(new TweenLite.fromTo(n, speed, {x: xe, y: ye}, {
                    x: i,
                    y: s,
                    onComplete: function () {
                        n.data("timeline").restart()
        ...
        n.find(".rs-pulse").each(function () {
            ...
            if (n.data("timeline") == t) {
                ...
                n.data("timeline").append(new TweenLite.fromTo(n, speed, {scale: i}, {
                    scale: r,
                    onComplete: function () {
                        n.data("timeline").restart()
                    }
        ...
        n.find(".rs-wave").each(function () {
            ...
            if (n.data("timeline") == t) {
                ...
                n.data("timeline").append(new TweenLite.fromTo(a, o, {a: 360}, {
                    a: 0,
                    ease: Linear.easeNone,
                    onUpdate: function () {
                        var e = a.a * (Math.PI / 180);
                        TweenLite.to(a.element, .1, {x: Math.cos(e) * a.unit, y: a.unit * (1 - Math.sin(e))})
                    },
                    onComplete: function () {
                        n.data("timeline").restart()
                    }
    ...
    var K = function (n, r, i, s) {
        ...
        l.find(".defaultimg").each(function () {
            ...
            if (s) {
                ...
                var a = i.w, f = a * n.width() - r.width, p = a * n.height() - r.height, d = Math.abs(i.x / f * 100),
                ...
                autoAlpha: 1, rotationZ: m, ease: b, x: u.x, y: u.y, scale: u.w, onUpdate: function () {
                    ...
                    var i = e * n.width() - r.width, s = e * n.height() - r.height,
                        u = Math.abs(n[0]._gsTransform.x / i * 100), a = Math.abs(n[0]._gsTransform.y / s * 100);
                    if (s == 0) a = 0;
                    if (i == 0) u = 0;
    ...
    var Y = function (n, r) {
        ...
        n.find(".defaultimg").each(function () {
            ...
            if (n != t && n.data("kenburn img") != t && n.data("kenburn img").length > 0) TweenLite.set(n.data("kenburn img"), {autoAlpha: 0})
        })
    };
    var Z = function (t, n) {
        ...
        if (n.parallax == "mouse" || n.parallax == "scroll+mouse" || n.parallax == "mouse+scroll") {
            ...
            t.on("mousemove.hoverdir, mouseleave.hoverdir", function (n) {
                ...
                switch (n.type) {
                    case"mousemove":
                        var i = t.offset().top, s = t.offset().left, o = r.data("enterx"), u = r.data("entery"),
                            a = o - (n.pageX - s), f = u - (n.pageY - i);
                        r.find(".tp-parallax-container").each(function () {
                            var t = e(this), n = parseInt(t.data("parallaxlevel"), 0) / 100, r = a * n, i = f * n;
                            TweenLite.to(t, .4, {x: r, y: i, ease: Power3.easeOut, overwrite: "all"})
                        });
                        break;
                    case"mouseleave":
                        r.find(".tp-parallax-container").each(function () {
    ...
    var et = function (t, n) {
        ...
        t.find(".tp-parallax-container").each(function (t) {
            ...
            TweenLite.to(n, .2, {y: i, ease: Power3.easeOut})
        });
        if (n.parallaxBgFreeze != "on") {
            var l = n.parallaxLevels[0] / 100, c = a * l;
            TweenLite.to(t, .2, {y: c, ease: Power3.easeOut})
        }
    };
    var tt = function (n, r) {
        var i = n.parent();
