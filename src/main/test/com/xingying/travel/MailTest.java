...
public class MailTest {
    ...
    public void sendTest() {
        mailService.sendSimpleMail("1465088322@qq.com", "我在测试邮箱", "测试测试测试测试测试得得得");
    }

    @Test
    public void sendHtml() {
        String content = "<html>\n" + "<body>\n" + "<h1> hello word </h3>" + "</body>\n" + "</html>";
        mailService.sendHtmlMail("1465088322@qq.com", "我在Html文件", content);
    }
    ...
    public void sendAttachments() throws MessagingException {
        ...
        mailService.sendAttachmentsMail("1465088322@qq.com", "这个邮件带了附件", "我有附件", filePath);
    }
    ...
    public void sendImg() throws MessagingException {
        ...
        mailService.sendImgMail("1465088322@qq.com", "我在Html文件", content, imgPath, imgId);
    }
    ...
    public void testTemolateMailTest() throws MessagingException {
        ...
        mailService.sendHtmlMail("1465088322@qq.com", "模板邮件", emailContent);
    }
}
